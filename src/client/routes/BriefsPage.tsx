    ...
    <div className="relay-enter min-h-screen">
      <header className="border-b border-relay-border px-5 py-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[1100px]">
          ...
          >
            <Link className="text-relay-accent hover:text-relay-text" to="/">
              Today’s brief
            </Link>
            <ChevronRight
              aria-hidden="true"
              className="size-3 text-relay-subtle"
            />
            <span aria-current="page" className="text-relay-muted">
              Archive
            </span>
          </nav>
          <p className="mt-5 font-mono text-[10px] uppercase tracking-[0.12em] text-relay-muted">
      ...
      <main className="mx-auto max-w-[1100px] px-5 py-7 sm:px-8 lg:px-10 lg:py-10">
        ...
        <section className="mt-10 border-l border-relay-border-strong pl-5">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-relay-muted">
            Sources define where evidence came from. Signals are the specific
            source-backed observations Relay analyzes against your theses.
            Briefs preserve the thesis-changing signals and citations used in
            each day’s synthesis.
          </p>
        </section>
      </main>
    </div>
